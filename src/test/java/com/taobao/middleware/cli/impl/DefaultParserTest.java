...
public class DefaultParserTest {
    ...
    public void testNotFulfilledRequiredOptions() throws CLIException {
        ...
        cli.addOptions(Arrays.asList(options));
        CommandLine evaluated = cli.parse(Collections.<String>emptyList());
    }
    ...
    public void testAnnotatedClassWithArgumentReceivingMultipleValues() {
        CLI cli = CLIs.create(CLIUsingMultipleArgument.class);
    ...
    public void testOptionsWithChoicesAndDefault() {
        ...
        line = cli.parse(Collections.<String>emptyList());
    ...
    private class CLIUsingAHelpOption {
        @com.taobao.middleware.cli.annotations.Option(help = true, flag = true, shortName = "h", longName = "help")
        public void setHelp(boolean b) {

        }

        @com.taobao.middleware.cli.annotations.Option(longName = "foo", required = true)
    ...
    private class CLIUsingAEnumOption {
        @com.taobao.middleware.cli.annotations.Option(longName = "retention")
    ...
    private class CLIUsingMultipleArgument {
        ...
        @com.taobao.middleware.cli.annotations.Argument(index = 0)
        ...
        @com.taobao.middleware.cli.annotations.Option(shortName = "s")
